				...
				function f(a) {
					if (a) {
						...
						B(c)
							...
							: ac(c)
								? ((c = c[0]),
									(c = "fixed" !== b.getComputedStyle(c).position ? 0 : c.getBoundingClientRect().bottom))
								: X(c) || (c = 0);
				...
				function ha(a, b, d, f, g, h, k, l) {
					...
					return function (a, b, c, d, e) {
						...
						b.$$destroyed ||
							(m
								? m.push(b, c, d, a)
								: (p.transcludeOnThisElement && (a = ka(b, p.transclude, e)), p(n, b, c, d, a)));
					};
				}
				function ia(a, b) {
							...
							((N = !1),
								d.$evalAsync(function () {
									...
									m.absUrl() === b &&
										(c
											? (m.$$parse(a), (m.$$state = f))
											: (n && h(b, g, f === m.$$state ? null : m.$$state), l(a, f)));
								}));
					}
					m.$$replace = !1;
				});
				...
				function (d, c) {
					"$inherit" === d
						? "*" === c
							? (b = !0)
							: ((a[c] = this.$$options[c]),
								"updateOn" === c && (a.updateOnDefault = this.$$options.updateOnDefault))
						: "updateOn" === c &&
							((a.updateOnDefault = !1),
							(a[c] = V(
					...
					link: {
						...
						post: function (d, k, h, l) {
							...
							d.$watchCollection(B.getWatchables, function () {
								...
								q.$isEmpty(a) ||
									((b = n.readValue()),
									(B.trackBy || A ? va(a, b) : a === b) || (q.$setViewValue(b), q.$render()));
							});
						},
					},
				};
