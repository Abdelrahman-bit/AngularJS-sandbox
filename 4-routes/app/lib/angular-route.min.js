		...
		y = b
			...
			.provider("$route", function () {
				...
				this.when = function (d, c) {
					...
					d &&
						((g = "/" === d[d.length - 1] ? d.substr(0, d.length - 1) : d + "/"),
					...
					function (d, c, f, g, l, k, q, p) {
						function m(a) {
							...
							(x =
								...
								e &&
								n.$$route === e.$$route &&
								(!n.reloadOnUrl || (!n.reloadOnSearch && b.equals(n.pathParams, e.pathParams)))) ||
								(!e && !n) ||
								(d.$broadcast("$routeChangeStart", n, e).defaultPrevented && a && a.preventDefault());
						}
						function s() {
							var a = t.current,
								e = n;
							...
							if (a)
								if (a.redirectTo)
									if (b.isString(a.redirectTo))
										((e.path = v(a.redirectTo, a.params)), (e.search = a.params), (e.hasRedirection = !0));
									else {
										var d = c.path(),
											f = c.search();
									...
									return g.resolve(l.invoke(a.resolveRedirectTo)).then(function (a) {
										b.isDefined(a) && ((e.url = a), (e.hasRedirection = !0));
										return e;
									});
							return e;
